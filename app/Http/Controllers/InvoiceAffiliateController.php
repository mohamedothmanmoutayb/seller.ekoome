...
class InvoiceAffiliateController extends Controller
{
    public function index(Request $request)
    {
        ...
        //dd($invoices);
        return view('backend.invoices.affiliate.index', compact('invoices'));
    }
    ...
    public function print(Request $request,$id)
    {
        ...
        if($invoice){
                ...
                return view('backend.invoices.affiliate.print', compact('invoice','user','sellerpara','colierfact','parameter'));
        }

        return redirect()->route('invoicesaffiliate.index');
    ...
    public function downloadInvoices(Request $request)
    {
        ...
        $zipFileName = 'invoicesaffiliates.zip';
        ...
        if ($zip->open(public_path($zipFileName), ZipArchive::CREATE) === TRUE) {   
            ...
            foreach($ids as $id){
                ...
                if($invoice){
                    ...
                    $pdf = PDF::loadView('backend.invoices.affiliate.pdf', compact('invoice','user','sellerpara','colierfact','parameter'));
