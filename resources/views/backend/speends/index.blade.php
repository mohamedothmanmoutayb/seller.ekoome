    ...
    <style>
        ...
        <div class="card card-body py-3">
            <div class="row align-items-center">
                <div class="col-12">
                    ...
                    <div>
                        <h4 class="mb-4 mb-sm-0 card-title">Ad Spend </h4>
                        <p class="mb-0 text-muted">Track your marketing expenses.</p>
                                    
                    </div>
                    <nav aria-label="breadcrumb" class="ms-auto">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item d-flex align-items-center">
                                <a type="button" class="btn btn-primary btn-rounded my-1" href="{{ route('campaigne.index')}}">ROI Simulator</a>
                            </li>
                        </ol>
                    </nav>
                    </div>
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="modal-content">
                        <form action="{{ route('speends.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">Add New Speend</h4>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12 my-2">
                                            <select class="form-control" name="platform_speend" id="platform_speend" required>
                                        ...
                                        <div class="col-md-12 my-2">
                                            <input type="date" class="form-control" name="date_speend" id="date_speend"
            ...
            <div class="card-body pt-0">
                <div class="row">
                    @foreach($medias as $v_media)
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    <a href="{{ route('speends.product',$v_media->id) }}">
                                        <img class="img-fluid platformes" src="{{ asset($v_media->image) }}" alt="" style="height: 400px !important;">
                                    </a>
                                </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" bis_skin_checked="1" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(184px, -325.203px, 0px);" data-popper-placement="top-start">                          
                                                <a class="dropdown-item " href="{{ route('speends.pack', $v_speend->id) }}" id=""> details</a>
                                            </div>
                                        </div> 
                                    </td>
                                </tr>
