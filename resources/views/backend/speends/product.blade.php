...
@section('content')
    <style>
        ...
        <div class="card card-body py-3">
            <div class="row align-items-center">
                <div class="col-12">
                    ...
                    <h4 class="mb-4 mb-sm-0 card-title">Assigned Product</h4>
                    <nav aria-label="breadcrumb" class="ms-auto">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item d-flex align-items-center">
                                <a type="button" class="btn btn-primary btn-rounded my-1" data-bs-toggle="modal" data-bs-target="#add-product">Assigned Product</a>
                            </li>
                        </ol>
                    </nav>
                    </div>
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div id="add-product" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  style="height:900px;">
                <div class="modal-dialog" style="height:900px;">
                    <div class="modal-content">
                        <form action="{{ route('speends.productstore') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="row">
                                        <input type="hidden" name="platform_speend" value="{{ $id}}" />
                  ...
                  <div class="card-body pt-0">
                    <div class="table-responsive theme-scrollbar" style="min-height: 350px;">
                      <table class="table table-bordernone">
                        ...
                        @if(!$productspends->isempty())
                        <tbody>
                            <?php $counter = 1; ?>
                            @foreach ($productspends as $v_speend)
                                <tr>
                                    <td>
                                    ...
                                    <td>{{ $v_speend['product']->name }}</td>
                                    <td>
                                         <img src="{{ $v_speend['product']->image }}" width="30" />
                                    </td>
                                    <td>{{ $v_speend->TotalSpend($v_speend->id )}}</td>
                                    <td>{{ $v_speend->Revenue($v_speend->id_product)}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" bis_skin_checked="1" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(184px, -325.203px, 0px);" data-popper-placement="top-start">                          
                                                <a class="dropdown-item " href="{{ route('speends.details', $v_speend->id) }}" id=""> details</a>
                                            </div>
                                        </div> 
                                    </td>
                                </tr>
                        ...
                        {{ $productspends->withQueryString()->links('vendor.pagination.courier') }}
                    </div>
