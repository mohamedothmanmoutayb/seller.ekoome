                    ...
                    <div class="row ">
                        ...
                        <div class="col-4 align-self-center">
                            <div class="form-group mb-0 text-right">
                                <a type="button" class="btn btn-primary btn-rounded waves-effect waves-light text-white w-50" id="paidwithout">Paid Order without invoice</a>
                                <a type="button" class="btn btn-primary btn-rounded waves-effect waves-light text-white w-45" id="paid">Paid Order Selected</a>
                            </div>
                        </div>
                                    ...
                                    <table id=""  class="table table-bordered table-striped table-hover contact-list" data-paging="true" data-paging-size="7">
                                        ...
                                        <tbody class="alldata">
                                            ...
                                            <tr class="accordion-toggle data-item" data-id="{{ $v_lead->id}}">
                                                <td>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="ids" class="custom-control-input checkBoxClass"  value="{{$v_lead->Id}}" id="pid-{{$counter}}">
