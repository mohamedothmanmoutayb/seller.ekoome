...
@section('content')
    ...
    <div class="content-wrapper">
                        ...
                        <from class="form-horizontal form-material">
                            <div class="form-group">
                                <div class="col-md-12 my-2">
                                    <select class="select2 form-control" id="assigne_manager"
                                ...
                                <div class="col-md-12 my-2">
                                    <input type="text" class="form-control" id="assigne_departement"
        ...
        <!-- Add User Popup Model -->
        <div id="orderpaid" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                ...
                <div class="row">
                    <div class="col-8 align-self-center ">
                        <h4 class="fw-bold py-3 mb-4 " style="display: -webkit-inline-box;"><span
                                class="text-muted fw-light">Dashboard /</span> Affiliates list&nbsp;
                    ...
                    <div class="col-4 d-flex justify-content-end">
                        <div class="form-group mb-0 text-right">
                            ...
                            <a type="button" class="btn btn-primary btn-rounded waves-effect waves-light text-white my-2"
                                data-bs-toggle="modal" data-bs-target="#orderpaid">Upload Order Paid</a>
                            <a type="button" class="btn btn-primary btn-rounded waves-effect waves-light text-white my-2"
                                data-bs-toggle="modal" data-bs-target="#adduser">Add New Affiliate</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-md-11 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" id="search"
                                                    placeholder="Name Customer ,  Email , Telephone" aria-label=""
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($customers as $v_customer)
                                            <tr>
                                                <td>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="ids"
                                                            ...
                                                            value="{{ $v_customer->id }}" id="pid-{{ $counter }}">
                                                ...
                                                <td>{{ $v_customer['leadss']->where('status_confirmation', 'confirmed')
                                                            ->wherein('status_livrison', ['delivered', 'returned'])
                                                            ->where('id_country', auth()->user()->country_id)
                                                            ->whereIn('status_payment', ['paid service', 'prepaid', 'return'])->count() }}
                                                </td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            @if ($v_customer->is_active == '0')
                                                                <a class="dropdown-item"
                                                                    href="{{ route('affiliates.active', $v_customer->id) }}">
                                                                    Active</a>
                                                            @else
                                                                <a class="dropdown-item"
                                                                    href="{{ route('affiliates.inactive', $v_customer->id) }}">
                                                                    InActive</a>
                                                            @endif
                                                            <a class="dropdown-item"
                                                                href="{{ route('affiliates.situation', $v_customer->id) }}">
                                                                Order need to paied</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('affiliates.orders', $v_customer->id) }}">
                                                                All Orders</a>
                                                            <a class="dropdown-item detailcustomer"
                                                                data-id="{{ $v_customer->id }}"> Details</a>
                                                            <a class="dropdown-item detailcustomer"
                                                                href="{{ route('affiliates.fees', $v_customer->id) }}">
                                                                Fees</a>
                                                            <a class="dropdown-item detailcustomer"
                                                                href="{{ route('affiliates.document', $v_customer->id) }}">
                                                                Docuemnts</a>
                                                            <a class="dropdown-item detailcustomer"
                                                                href="{{ route('affiliates.parameter', $v_customer->id) }}">
                                                                Parameters</a>
                                                        </div>
                                                    </div>
                                                </td>
    ...
    <div id="detailuser" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <from class="form-horizontal form-material">
                        <div class="form-group">
                            <div class="col-md-12 my-2">
                                <input type="text" class="form-control" id="detail_departement"
                                    placeholder="Departement">
                            </div>
                            <div class="col-md-12 my-2">
                            ...
                            <div class="modal-body d-flex justify-content-center">
                                <button type="button" class="btn btn-primary waves-effect" id="details">Save</button>
                                <button type="button" class="btn btn-primary waves-effect"
                                    data-bs-dismiss="modal">Cancel</button>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.email == false) {
                            toastr.error('Opps.', 'This Email Aready Existing!', {
                                "showMethod": "slideDown",
                                "hideMethod": "slideUp",
                                timeOut: 2000
                            });
                        ...
                        if (response.departement == false) {
                            toastr.error('Opps.', 'This Departement Aready Existing!', {
                                "showMethod": "slideDown",
                                "hideMethod": "slideUp",
                                timeOut: 2000
                            });
        ...
        $(function() {
            ...
            $('#details').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success == true) {
                            toastr.success('Good Job.', 'User Has been Updated Success!', {
                                "showMethod": "slideDown",
                                "hideMethod": "slideUp",
                                timeOut: 2000
                            });
