                    ...
                    <div class="row">
                        <div class="col-10 align-self-center">
                            <h3 class="page-title"><span
                                class="text-muted fw-light">Costumers /</span> Situation Delivred</h3>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                    ...
                                    <table id=""  class="table table-bordered table-striped table-hover contact-list" data-paging="true" data-paging-size="7">
                                        ...
                                        <tbody class="alldata">
                                            ...
                                            <tr class="accordion-toggle data-item" data-id="{{ $v_delivred->id}}">
                                                ...
                                                <td>
                                                    <a href="{{ route('payment.details', $id )}}" class="text-inverse pr-2" data-toggle="tooltip" title="All Orders"><i class="ti ti-marker-alt"></i></a>
                                                </td>
                                            </tr>
