                                            ...
                                            <tbody class="alldata">
                                                ...
                                                @foreach ($invoices as $v_invoice)
                                                    ...
                                                    @endforeach --}}
                                                        ...
                                                        <td>
                                                            <a href="{{ route('invoices-vendor.print', $v_invoice->id) }}"
    ...
    <script>
        $(function(e) {
            ...
            $('#paid').click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('invoices-vendor.paied') }}',
                    cache: false,
                    data: {
                        ids: allids,
                        _token: '{{ csrf_token() }}'
            ...
            $('#export').click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('invoices-vendor.export') }}',
                    cache: false,
                    data: {
                        ids: allids,
                        _token: '{{ csrf_token() }}'
                    ...
                    success: function(response, invoices) {
                        $.each(allids, function(key, val, invoices) {
                            ...
                            window.location = ('invoices-vendor/export-download/' + a);
                        });
                    }
                });
            });
            $('#downloadpdf').click(function(e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ route('invoices-vendor.downloadInvoice') }}',
                    cache: false,
                    data: {
                        ids: allids,
                    },
