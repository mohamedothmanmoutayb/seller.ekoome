...
@section('content')
                ...
                <div class="row">
                    <div class="col-6 align-self-center ">
                        <h4 class="fw-bold py-3 mb-4 " style="display: -webkit-inline-box;"><span
                                class="text-muted fw-light">Dashboard /</span> Zones &nbsp;
                        ...
                        <div class="form-group mb-0 text-right">
                            <div class="form-group mb-0 text-right">
                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light"
                                    data-bs-toggle="modal" data-bs-target="#add-contact">Add New Zone</button>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-11 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" id="search"
                                                    placeholder="Name Zone" aria-label="" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <from class="form-horizontal form-material">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 m-b-20 mt-4">
                                                        <input type="text" class="form-control" id="id_zone"
                                                            placeholder="Zone">
                                                    </div>
                                                </div>
                                            </from>
                            ...
                            <div class="table-responsive">
                                <table id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list"
                                    ...
                                    <tbody>
                                        ...
                                        $counter = 1;
                                        ?>
                                        @foreach ($zones as $v_zone)
                                            <tr>
                                                <td>{{ $counter }}</td>
                                                <td>{{ $v_zone->name }}</td>
                                                <td>
                                                    @foreach ($v_zone['city'] as $v_zon)
                                                        {{ $v_zon->name }}
                                                    @endforeach
                                                </td>
                                                <td>{{ $v_zone->created_at }}</td>
                                                <td>
                                                    <a data-id="{{ $v_zone->id }}" class="text-inverse deleted"
                                ...
                                {{ $zones->withQueryString()->links('vendor.pagination.courier') }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.getElementById('pagination').onchange = function() {
            if (window.location.href == "https://admin.ecomfulfilment.eu/zones") {
