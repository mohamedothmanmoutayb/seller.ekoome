    ...
    <div class="content-wrapper">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($zipcodes as $v_zipcode)
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach ($v_zipcode['country'] as $v_country)
                                                        {{ $v_country->name }}
                                                    @endforeach
                                                </td>
        ...
        <script>
            document.getElementById('pagination').onchange = function() {
                if (window.location.href == "https://www.admin.ecomfulfilment.eu/zipcode") {
