                ...
                <div class="row">
                    <div class="col-6 align-self-center ">
                        <h4 class="fw-bold py-3 mb-4 " style="display: -webkit-inline-box;"><span
                                class="text-muted fw-light">Dashboard /</span> Referral links &nbsp;
                        ...
                        <div class="form-group mb-0 text-right">
                            <div class="form-group mb-0 text-right">
                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light"
                                    data-bs-toggle="modal" data-bs-target="#add-province">Add Referral link <i class="ti ti-plus"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-11 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" id="search"
                                                    placeholder="reference" aria-label="" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">Add New Referral Link </h4>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary waves-effect"
                                                id="saveprovince">generate</button>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list"
                                    ...
                                    <tbody>
                                        ...
                                        $counter = 1;
                                        ?>
                                        @foreach ($parinage as $v_parinage)
                                            <tr>
                                                <td>{{ $counter }}</td>
                                                <td>{{ $v_parinage->url }}</td>
                                                <td>{{ $v_parinage->note }}</td>
                                                <th> <i class="badge bg-primary">{{ $v_parinage->ref }}</i> </th>
                                                <td>{{ $v_parinage->created_at }}</td>
                                                <td>
                                                    <a data-id="{{ $v_parinage->id }}" class="text-inverse deleted"
...
<button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <script>
        $(document).ready(function() {
                        ...
                        success: function(response) {
                            ...
                            if (response[1] == true) {
                                toastr.success('Good Job.',
                                    'Referral link Has been Addess Success!', {
            ...
            //                     toastr.success('Good Job',
            //                         'Parrainage Has been Update Success!', {
            //                             "showMethod": "slideDown",
            //                             "hideMethod": "slideUp",
            //                             timeOut: 2000
            //                         });
                ...
                $('.deleted').click(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response[1]== true) {
                                toastr.success('Good Job.',
                                    'Referrel link Has been Deleted Success!', {
                                        "showMethod": "slideDown",
                                        "hideMethod": "slideUp",
                                        timeOut: 3000
                                    });
