                    ...
                    <div class="col-md-9 d-flex flex-column justify-content-center">
                        <div class="card mb-0 bg-body auth-login m-auto w-100">
                                    ...
                                    <div class="row justify-content-center py-4">
                                        <div class="col-lg-11">
                                            <div class="card-body">
                                                ...
                                                <h4 class="lh-base mb-2" style="font-size: 23px;">Your Ecommerce, Fully
                                                    Under Control</h4>
                                                <p class="mb-4">Sign in to access your all-in-one platform for COD &
                                                    dropshipping order management</p>
                                                <div class="row">
                            ...
                            <a class="btn btn-white shadow-sm text-dark link-primary border fw-semibold d-flex align-items-center justify-content-center rounded-1 py-6" href="javascript:void(0)" role="button">
                              <img src="{{ asset('assets/images/svgs/facebook-icon.svg') }}" alt="matdash-img" class="img-fluid me-2" width="18" height="18">
                              <span class="d-none d-xxl-inline-flex"> Sign in with </span>&nbsp; Facebook
                            </a>
                          </div>
                          <div class="col-6">
                            <a class="btn btn-white shadow-sm text-dark link-primary border fw-semibold d-flex align-items-center justify-content-center rounded-1 py-6" href="javascript:void(0)" role="button">
                              <img src="{{ asset('assets/images/svgs/google-icon.svg') }}" alt="matdash-img" class="img-fluid me-2" width="18" height="18">
                          ...
                          <span class="border-top w-100 position-absolute top-50 start-50 translate-middle"></span>
                                                ...
                                                <form id="loginform" method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <a class="text-primary link-dark fs-2"
                                                                href="../horizontal/authentication-forgot-password2.html">Forgot
                                                                Password ?</a>
                                                        </div>
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-dark w-100 py-8 mb-4 rounded-1">Sign In</button>
                                                    <div class="d-flex align-items-center">
                                                        <p class="fs-12 mb-0 fw-medium">Don’t have an account yet?</p>
                                                        <a class="text-primary fw-bolder ms-2"
                                                            href="../horizontal/authentication-register2.html">Sign Up
                                                            Now</a>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <div class="col-xl-6 d-none d-xl-block">
                                    <div class="row justify-content-center align-items-start h-100 "
                                        ...
                                        <div class="col-lg-9">
                                            <div id="auth-login" class="carousel slide auth-carousel mt-3 pt-4"
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <div
                                                            ...
                                                            <img src="{{ asset('assets/images/backgrounds/order.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">📦 Order Management</h4>
                                                            <p class="fs-12 mb-0">Handle Cash on Delivery &
                                                                Dropshipping in any country.</p>
                                                    ...
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/call.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">☎️ Call Center Management</h4>
                                                            <p class="fs-12 mb-0"> Manage sales agents, track
                                                                performance, and boost conversions.</p>
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-primary rounded-1">Learn More</a>
                                                        </div>
                                                    </div>
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/user.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">👥 Team Management</h4>
                                                            <p class="fs-12 mb-0">Assign roles, monitor productivity &
                                                    ...
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/lastmile.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">🚚 Shipping Integrations</h4>
                                                            <p class="fs-12 mb-0">Connect with top logistics companies
                                                                seamlessly.</p>
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-primary rounded-1">Learn More</a>
                                                        </div>
                                                    ...
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/store.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">🛒 Store Integrations</h4>
                                                            <p class="fs-12 mb-0">Sync with your preferred store
                                                                platforms instantly.</p>
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-primary rounded-1">Learn More</a>
                                                        </div>
                                                    </div>
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/bill.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">💰 Cash Flow Control</h4>
                                                            <p class="fs-12 mb-0">Track revenue, COD payments, returns,
                                                                and payouts in real-time.</p>
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-primary rounded-1">Learn More</a>
                                                        </div>
                                                    </div>
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/warehouse.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">📊 Inventory & Stock Management</h4>
                                                            <p class="fs-12 mb-0">Stay in control of your products and
                                                                avoid overselling.</p>
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-primary rounded-1">Learn More</a>
                                                        </div>
                                                    ...
                                                    <div class="carousel-item">
                                                        <div
                                                            class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                                                            <img src="{{ asset('assets/images/backgrounds/aiageent.png') }}"
                                                                alt="login-side-img" width="300"
                                                                class="img-fluid" />
                                                            <h4 class="mb-0">🤖 WhatsApp AI Agent & Bots</h4>
                                                            <p class="fs-12 mb-0">Automate chats, confirm orders,
                                                                answer FAQs, and increase efficiency.</p>
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-primary rounded-1">Learn More</a>
                                                        </div>
                                                    </div>
